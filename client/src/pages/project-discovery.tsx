          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{project.industry || "Not specified"}</p>
              </div>
              {project.websiteUrl && (
                <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {businessProfile ? (
                ...
                <div className="text-sm text-muted-foreground space-y-2">
                  <p>• Business model and value proposition</p>
                  <p>• Target market and customer segments</p>
                  <p>• Competitive landscape analysis</p>
                  <p>• Website content extraction</p>
                  <p>• Market opportunity assessment</p>
                  <p>• Growth strategy recommendations</p>
                </div>
              )}
            </CardContent>
          </Card>

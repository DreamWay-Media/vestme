  ...
  "flex h-full w-full flex-col bg-sidebar text-sidebar-foreground",
  {
    variants: {
      variant: {
        default: "border-r",
        floating:
          "border border-border/40 bg-sidebar/95 backdrop-blur supports-[backdrop-filter]:bg-sidebar/60",
        inset: "border-r",
      },
      side: {
        left: "",
...
>(({ className, variant, side = "left", ...props }, ref) => {
  return (
    <div
      ref={ref}
...
>(({ className, showIcon = false, ...props }, ref) => (
  ...
  >
    ...
    <div className="h-4 rounded-sm bg-sidebar-primary/10 max-w-[--skeleton-width] flex-1" />
  </div>
))
